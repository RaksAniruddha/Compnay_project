...
import { addProduct, bulckStockEditByAdmin, deleteProduct, editProduct, 
    getAllProduct, getAllProductAdmin, stockAlert, stockEdit, 
    trackStock} from '../controller/product.controller.js';
import { upload } from '../utills/multer.js';

const router= express.Router();

router.route("/").get(isAuthenticated,getAllProduct);
router.route("/addProduct/:caterogyId").post(isAuthenticated,upload.single("productImage"),addProduct);
